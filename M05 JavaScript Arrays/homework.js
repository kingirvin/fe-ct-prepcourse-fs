...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   mayor=0;
   arrayOfNums.forEach(num=>{if(num>mayor) mayor=num})
   return mayor;
}
...
function cuentoElementos(array) {
   ...
   // Tu código:
   let mayor=0;
   array.forEach(num=>{if(num>18) mayor++})
   return mayor;
}
...
function mesesDelAño(array) {
   ...
   // Tu código:
   let meses=Array();
   array.forEach(mes=>{if(mes==="Enero" || mes ==="Marzo") meses.push(mes)})
...
function mayorACien(array) {
   ...
   // Tu código:
   let mayor=Array();
   array.forEach(num=>{if(num>100) mayor.push(num)})
   return mayor;
}
